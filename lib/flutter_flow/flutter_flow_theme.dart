...
abstract class FlutterFlowTheme {
  ...
  get dateTimePickerColor => null;

  get dateTimePickerBackground => null;

  get dateTimePickerHint => null;
}
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3E7C37);
  late Color secondary = const Color(0xFFCB6432);
  late Color tertiary = const Color(0x00A9AFB0);
  late Color alternate = const Color(0xFFCB6432);
  ...
  late Color accent1 = const Color(0xFFA24C9D);
  late Color accent2 = const Color(0xFFF4B400);
  late Color accent3 = const Color(0xFFFF3E30);
  late Color accent4 = const Color(0xFF25A5E2);
  ...
  late Color dateTimePickerColor = const Color(0xFF3E7C37);
  late Color dateTimePickerHint = const Color(0xFF6B7280); // Optional hint color
  late Color dateTimePickerBackground = Colors.white;
}
